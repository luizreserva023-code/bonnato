...
export const eventOutbox = pgTable("event_outbox", {
  ...
  status: varchar("status", { length: 24 }).$type<"pending" | "processing" | "processed" | "failed">().default("pending").notNull(),
...
export const authEventLogs = pgTable("auth_event_logs", {
  ...
  event: varchar("event", { length: 32 }).$type<"login_success" | "login_failure" | "provider_connected" | "provider_disconnected" | "profile_synced" | "account_deleted">().notNull(),
  ipAddress: varchar("ipAddress", { length: 64 }),
