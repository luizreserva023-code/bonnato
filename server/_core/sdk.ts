import { AXIOS_TIMEOUT_MS, COOKIE_NAME, DEFAULT_SESSION_MS } from "../../shared/const.ts";
...
const normalizeSessionAppId = (appId: unknown) =>
  isNonEmptyString(appId) ? appId : ENV.sessionAppId;
