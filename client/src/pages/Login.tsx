    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          <img src={MASCOTE_URL} alt="Bonatto" className="w-12 h-12" />
          <img src={LOGO_TIPOGRAFICA_URL} alt="Bonatto" className="h-8 w-auto" />
        </div>
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-black text-white leading-tight mb-6">
            ...
            <span className="text-white/60">pedir de novo</span>
          </h1>
      ...
      <div className="flex-1 relative flex flex-col items-center justify-center p-8 min-h-screen md:min-h-0 overflow-hidden bg-white">
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center mb-8 md:hidden">
            ...
            >
              <img src={MASCOTE_URL} alt="Bonatto" className="w-16 h-16" />
            </div>
            <img src={LOGO_TIPOGRAFICA_URL} alt="Bonatto" className="h-8 w-auto" style={{ filter: "invert(1) sepia(1) saturate(5) hue-rotate(300deg) brightness(0.4)" }} />
          </div>
            ...
            {mode !== "forgot" && (
              <>
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <span className="text-xs text-gray-400">ou use e-mail</span>
                  <div className="flex-1 h-px bg-gray-200" />
                </div>
              </>
            )}
